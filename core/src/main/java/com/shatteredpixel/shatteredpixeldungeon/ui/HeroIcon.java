...
//	public static final int 				= 143;
	...
	public static final int POWER_SHOT		= 144;
	public static final int JUGGLING		= 145;
	public static final int SHARPSHOOTING	= 146;
//	public static final int 				= 147;

//	public static final int 				= 148;
//	public static final int 				= 149;
//	public static final int 				= 150;
//	public static final int 				= 151;

//cleric spells
public static final int GUIDING_LIGHT   = 152;
	public static final int HOLY_WEAPON     = 153;
	public static final int HOLY_WARD       = 154;
	public static final int HOLY_INTUITION  = 155;
	public static final int SHIELD_OF_LIGHT = 156;
	public static final int RECALL_GLYPH    = 157;
	public static final int SUNRAY          = 158;
	public static final int DIVINE_SENSE    = 159;
	public static final int BLESS           = 160;
	public static final int CLEANSE         = 161;
	public static final int RADIANCE        = 162;
	public static final int HOLY_LANCE      = 163;
	public static final int HALLOWED_GROUND = 164;
	public static final int MNEMONIC_PRAYER = 165;
	public static final int SMITE           = 166;
	public static final int LAY_ON_HANDS    = 167;
	public static final int AURA_OF_PROTECTION = 168;
	public static final int WALL_OF_LIGHT   = 169;
	public static final int DIVINE_INTERVENTION = 170;
	public static final int JUDGEMENT       = 171;
	public static final int FLASH           = 172;
	public static final int BODY_FORM       = 173;
	public static final int MIND_FORM       = 174;
	public static final int SPIRIT_FORM     = 175;
	public static final int BEAMING_RAY     = 176;
	public static final int LIFE_LINK       = 177;
	public static final int STASIS          = 178;
	//cleric new spells
	public static final int DIVINE_BLAST	= 179;
	public static final int DIVINE_RAY	    = 180;
	public static final int HOLY_BOMB	    = 181;
	public static final int RESURRECTION    = 182;
	public static final int HOLY_MANTLE	    = 183;
	public static final int POWER_OF_LIFE   = 184;
	public static final int INDUCE_AGGRO    = 185;
	public static final int SPELL_BURST     = 186;
	public static final int TIME_AMP	    = 187;
	public static final int WEAKENING_HEX   = 188;
	public static final int STUN		    = 189;
	public static final int THUNDER_IMBUE	= 190;
	public static final int ARCANE_ARMOR 	= 191;
	public static final int ENCHANT		    = 192;
